...
export default function Team() {
  ...
  const members = [
    ...
    },
    {
      ...
      linkedin: "https://www.linkedin.com/in/bala-sahana-senthil-kumaran-a7143831b",
    },
    {
    ...
    <div className="bg-black text-white min-h-screen py-16 px-6 md:px-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
        {members.map((m, i) => (
          <div
            key={i}
            className="bg-gradient-to-b from-red-900/40 to-black border border-red-500 rounded-2xl p-6 text-center shadow-lg hover:scale-105 transition"
            data-aos="fade-up"
          ...
          >
            <img
              src={m.img}
              alt={m.name}
              className="mx-auto rounded-full w-32 h-32 object-cover border-4 border-red-500 shadow-md"
            />
            <h2 className="text-xl font-bold mt-4 text-yellow-400">{m.name}</h2>
